        ...
        <div x-data="{ newPhotoUrl: null }" class="flex flex-col items-center text-center">
            <form id="form-photo-upload" method="POST" action="{{ route('admin.profile.photo.update') }}" enctype="multipart/form-data" class="w-full">
                ...
                <div class="relative inline-block mb-4 group">
                    ...
                    <img :src="newPhotoUrl || '{{ $user->foto_profil ? asset('storage/' . $user->foto_profil) : asset('images/default-avatar.png') }}'" alt="Foto Profil" class="h-32 w-32 rounded-full object-cover border-4 border-white shadow-lg transition-transform duration-300 group-hover:scale-105">
                </div>
