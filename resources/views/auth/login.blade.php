...
<div class="flex flex-col lg:flex-row min-h-screen">
    ...
    <div class="w-full lg:w-1/2 bg-[#1E3A8A] flex items-center justify-center p-6 lg:p-12">
        {{-- Penambahan animasi: durasi diperlambat untuk efek yang lebih halus --}}
        ...
        <div class="text-center">
            @if (Route::has('password.request'))
                ...
                <a class="text-sm text-blue-600 hover:underline hover:text-blue-800 transition-colors duration-300" href="{{ route('password.request') }}">
                    Lupa Password?
                </a>
            @endif
        </div>
...
<style>
    ...
    /* Penambahan animasi baru: fadeInDown */
    ...
    /* Penambahan animasi baru: bounce */
    @keyframes bounce {
    ...
    /* Modifikasi 'pulseHover' untuk efek yang lebih halus */
